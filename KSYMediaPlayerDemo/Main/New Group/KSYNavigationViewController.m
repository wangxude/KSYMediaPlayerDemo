...
+(void)initialize{
    ...
    //[UIColor colorWithRed:240/255.0 green:156/255.0 blue:30/255.0 alpha:1]
    [[UINavigationBar appearance] setTitleTextAttributes:
     @{NSFontAttributeName:[UIFont systemFontOfSize:17],
       NSForegroundColorAttributeName:[UIColor whiteColor]}];
    [[UINavigationBar appearance]setBarTintColor:[UIColor colorWithRed:8/255.0 green:8/255.0 blue:11/255.0 alpha:1/1.0]];
